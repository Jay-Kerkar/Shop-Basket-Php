...
$select_banner = mysqli_query($database_connection,"select * from Banners where Status='1'");
?>
...
<section class="hero-slider">	
	<section class="midium-banner">
		<div class="container">
			<div class="row">
		<?php  
					while($fetch_banner = mysqli_fetch_array($select_banner)){
		?>
		<!-- Single Banner  -->
				<div class="col-lg-6 col-md-6 col-12">
					<div class="single-banner">
						<img src="<?php echo BANNER_IMAGE_SITE_PATH.$fetch_banner['Banner_Image'] ?>">
						<div class="content">
									<h3><?php echo $fetch_banner['Main_Heading'] ?></h3>
							<p><?php echo $fetch_banner['Sub_Heading'] ?></p>
							<?php  
									if($fetch_banner['Button_Link']!='' && $fetch_banner['Button_Text']!=''){
									?>
							<a href="<?php echo $fetch_banner['Button_Link'] ?>" target="_blank"><?php echo $fetch_banner['Button_Text'] ?></a>
							<?php } ?>
							</div>
						</div>
					<!-- /End Single Banner  -->
...
<?php } ?>	
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4 col-md-6 col-12">
					...
					<?php 
  $get_products_data = get_products_data($database_connection,'new_arrivals',4);
  ...
  foreach($get_products_data as $products_data){
					...
					<div class="single-list">
						<div class="row">
							...
							<a href="product_details.php?id=<?php echo $products_data['Id']?>">
									<img src="<?php echo PRODUCT_MAIN_IMAGE_SITE_PATH.$products_data['Product_Image']?>"></a>
									<a href="product_details.php?id=<?php echo $products_data['Id']?>" class="buy"><i class="fa fa-shopping-bag"></i></a>
								 </div>
								<a title="Add To Cart" href="product_details.php?id=<?php echo $products_data['Id']?>"><i class=" fa fa-shopping-bag "></i><span>Add To Cart</span></a>
							...
							<div class="col-lg-6 col-md-6 col-12 no-padding">
								<div class="content">
									<h4 class="title"><a href="product_details.php?id=<?php echo $products_data['Id']?>"><?php echo $products_data['Product_Name']?></a></h4>     
									<div class="product-price">
									<span class="product-mrp" style="text-decoration: line-through; opacity: 0.6; margin-right: 2px; margin-bottom:300px;">MRP : <?php echo $products_data['Product_MRP']?></span>
									</div>
				...
				<div class="col-lg-4 col-md-6 col-12">
					...
					<?php  
					$get_products_data = get_products_data($database_connection,'best_seller',4);
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-12 no-padding">
								<div class="content">
									<h4 class="title"><a href="product_details.php?id=<?php echo $products_data['Id']?>"><?php echo $products_data['Product_Name']?></a></h4>     
									<div class="product-price">
									<span class="product-mrp" style="text-decoration: line-through;opacity: .6;margin-right: 2px;margin-bottom:300px;">MRP : <?php echo $products_data['Product_MRP']?></span>
									</div>
									<p class="price with-discount">Price : <?php echo $products_data['Product_Price']?></p>
