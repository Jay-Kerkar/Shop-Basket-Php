...
$select_product = "select Products.*,Categories.Category from Products,Categories where Products.Product_Category = Categories.Id order by Products.Id desc";
	...
	<div class="orders">
	   <div class="row">
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   <h4 class="box-title">Products | Ecommerce Website</h4>
