...
<html class="no-js" lang="">
   ...
   <head>
      ...
      <title>Control Panel | Ecommerce Website</title>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
               <ul class="nav navbar-nav">
                 ...
                 <li class="menu-item-has-children dropdown">
                  ...
                  <li class="menu-item-has-children dropdown">
                     <a href="coupon_codes.php">Coupon Codes</a>
                  </li>
				  <li class="menu-item-has-children dropdown">
                     <a href="administrators.php" >Administrators</a>
                  </li>
				  <li class="menu-item-has-children dropdown">
                     <a href="compliants_suggestions.php" >Complaints / Suggestions</a>
                  </li>
                  <li class="menu-item-has-children dropdown">
         ...
         <header id="header" class="header">
            <div class="top-left">
               <div class="navbar-header">
                  ...
                  <a class="navbar-brand hidden" href="control_panel.php"><img src="images/logo2.png" alt="Logo"></a>
